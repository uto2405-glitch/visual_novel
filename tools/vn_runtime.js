...
(function (global) {
  ...
  var CSS = [
    ...
    ".vnr-log,.vnr-scenes{top:7%;bottom:7%;left:max(9%,calc(var(--vnr-gut,0px) + 16px));",
    "right:max(9%,calc(var(--vnr-gut,0px) + 16px))}",
    ...
    /* 설정 */
    ".vnr-set{top:calc(52px + env(safe-area-inset-top));right:calc(14px + var(--vnr-gut,0px));",
    "width:min(330px,86%,calc(var(--vnr-picw,100%) - 28px));gap:14px}",
